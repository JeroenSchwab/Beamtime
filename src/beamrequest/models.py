...
#	Energy = models.CharField(max_length=20, choices=ION_ENERGY_CHOICES, default='SELECT')
	...
	Energy = ChainedForeignKey(Energys, chained_field="Ion_Species", chained_model_field="Ion_Species",	show_all=False,	auto_choose=True, sort=True, blank=True, null=True)
	Flux = models.CharField(max_length=50, blank = True)
